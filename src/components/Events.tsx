...
export default function Events() {
  ...
  return (
    <Container sx={{ pt: 6, pb: 6 }}>
      ...
      <Button variant="outlined" color="primary" size="large" href='https://docs.google.com/spreadsheets/d/1JoWXemxTDbMSsSMJrWOZylYBXePxSy_-21jmeeDEKtM/view#gid=928498616' target="_blank" sx={{ mt: 2 }}>
