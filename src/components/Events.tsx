  ...
  return (
    <Container sx={{ pt: 10, pb: 5 }}>
      ...
      <Box mb={6} border={1} sx={{ borderColor: grey[400] }}>
        <div className="flourish-embed" data-src="visualisation/12018966"></div>
      </Box>
      <Button variant="contained" color="error" size="large" href='https://docs.google.com/spreadsheets/d/1JoWXemxTDbMSsSMJrWOZylYBXePxSy_-21jmeeDEKtM/view#gid=928498616' target="_blank" sx={{ mt: 2 }}>
        주요기업 정보유출 사고 데이터 살펴보기
      </Button>
    </Container>
  );
}
